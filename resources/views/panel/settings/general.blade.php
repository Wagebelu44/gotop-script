            ...
            <div class="card-body">
                <form action="{{ route('admin.setting.generalUpdate') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="relative">
                        ...
                        <div class="form-group">
                            <label class="control-label" for="drip_feed_interval">Minimum drip-feed interval (Minutes)</label>
                            <input type="number" step="1" min="0" class="form-control" value="{{ old('drip_feed_interval', isset($general) && $general->drip_feed_interval ? $general->drip_feed_interval:'') }}" name="drip_feed_interval">
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-6">
                                <label class="control-label" for="newsfeed_align">News Feed Position</label>
