...
<meta charset="utf-8">
    ...
    <title>What's new on {{ config('app.name', 'Laravel') }}</title>
                    ...
                    <div class="featureControls">
                        <div class="social featureControl" data-action="share">
                            ...
                            <div class="socialList">
                                <ul>
                                    <li>
                                        <a target="_blank" href="https://www.facebook.com/dialog/share?app_id=213351392791601&amp;display=page&amp;href=https%3A%2F%2Fnews.justanotherpanel.com%2Fen%2F211799-217001" class="shareLink redirected" data-social="facebook">Facebook</a>
                                    </li>
                                    <li>
                                        <a target="_blank" href="https://twitter.com/intent/tweet?via=getbeamer&amp;text=&amp;url=https%3A%2F%2Fnews.justanotherpanel.com%2Fen%2F211799-217001" class="shareLink redirected" data-social="twitter">Twitter</a>
                                    </li>
                                    <li>
                                        <a target="_blank" href="https://www.linkedin.com/shareArticle?source=Beamer&amp;mini=true&amp;title=&amp;summary=OUR IG FOLLOWERS REAL PACKAGES are working SUPER FINE ! WE also enabled a new lower package 1919 - Real Instagram Followers [10k to 25k] [149$ Price] [ADS] Waiting for your Orders ! - JAP Team !&amp;url=https%3A%2F%2Fnews.justanotherpanel.com%2Fen%2F211799-217001" class="shareLink redirected" data-social="linkedin">LinkedIn</a>
                                    </li>
                                    <li>
                                        <div onclick="BeamerEmbed.copyLink(this)" class="shareLink" data-social="copy">
                                            <span class="copyLink">Copy link</span>
                                            <span class="copiedLink" style="display: none;">Copy link</span>
                    ...
                    <div id="feedback211799" class="featureFeedback">
                        <div id="reactions" class="emojis">
                            <span class="emojiContainer">
                                <img src="{{ asset('notify-assets/images/emojiNeg.svg ') }}" id="negativeemoji211799" class="emoji" style="padding: 2px;" alt="emoji negtive reaction" title="Negative">
                            </span>
                            <span class="emojiContainer">
                                <img src="{{ asset('notify-assets/images/emojiNeut.svg') }}" id="neutralemoji211799" class="emoji" style="padding-bottom: 0px;" alt="emoji neutral reaction" title="Neutral">
                            </span>
                            <span class="emojiContainer">
                                <img src="{{ asset('notify-assets/images/emojiPos.svg') }}" id="positiveemoji211799" class="emoji" style="padding-bottom: 0px;" alt="emoji positive reaction" title="Positive">
                            </span>
                        </div>
                    </div>
                </div>
