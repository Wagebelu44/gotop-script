...
(function ($) {
  ...
  Selectpicker.prototype = {
    ...
    createDropdown: function () {
        ...
        actionsbox =
          '<div class="bs-actionsbox">' +
            '<div class="btn-group btn-group-sm btn-block">' +
              '<button type="button" class="actions-btn custom-action-button bs-select-all btn ' + classNames.BUTTONCLASS + '">' +
                this.options.selectAllText +
              '</button>' +
              '<button type="button" class="actions-btn custom-action-button bs-deselect-all btn ' + classNames.BUTTONCLASS + '">' +
      ...
      drop =
        '<div class="dropdown custom-drop-down-bootstrap-select  bootstrap-select' + showTick + inputGroup + '">' +
